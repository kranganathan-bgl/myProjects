...
@XmlType(name = "AnyAddressBaseType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "premise",
    "street",
    "thoroughfare",
    "postTown",
...
public class AnyAddressBaseType {
    ...
    @XmlElement(name = "Street", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
