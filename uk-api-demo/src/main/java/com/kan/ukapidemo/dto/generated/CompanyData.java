...
public class CompanyData {
    ...
    @XmlElement(name = "TradingOnMarket")
    protected Boolean tradingOnMarket;
    @XmlElement(name = "DTR5Applies")
    protected Boolean dtr5Applies;
    @XmlElement(name = "PSCExemptAsTradingOnRegulatedMarket")
    protected Boolean pscExemptAsTradingOnRegulatedMarket;
    @XmlElement(name = "PSCExemptAsSharesAdmittedOnMarket")
    protected Boolean pscExemptAsSharesAdmittedOnMarket;
    @XmlElement(name = "PSCExemptAsTradingOnUKRegulatedMarket")
    ...
    @XmlElement(name = "NextDueDate", required = true, type = String.class)
    @XmlJavaTypeAdapter(LocalDateXmlAdapter.class)
    protected LocalDate nextDueDate;
    @XmlElement(name = "RegisteredOfficeAddress", required = true)
    protected UKAddressType registeredOfficeAddress;
    @XmlElement(name = "SailAddress")
    protected UKAddressType sailAddress;
    @XmlElement(name = "SailRecords")
    ...
    @XmlElement(name = "Officers", required = true)
    protected CompanyData.Officers officers;
    @XmlElement(name = "PSCs")
    protected CompanyData.PSCs psCs;
    @XmlElement(name = "StatementOfCapital")
     ...
     *     
     */
    public void setNextDueDate(LocalDate value) {
    ...
    public static class Officers {
        ...
        @XmlElements({
            @XmlElement(name = "Director", type = CompanyData.Officers.Director.class),
            @XmlElement(name = "Secretary", type = CompanyData.Officers.Secretary.class),
            @XmlElement(name = "Member", type = CompanyDataMemberType.class)
        })
            ...
            extends CompanyDataDirectorType
        {
            ...
            @XmlElement(name = "AppointmentDate", required = true, type = String.class)
            @XmlJavaTypeAdapter(LocalDateXmlAdapter.class)
            @XmlSchemaType(name = "date")
            protected LocalDate appointmentDate;
            @XmlElement(name = "ResignationDate", type = String.class)
            @XmlJavaTypeAdapter(LocalDateXmlAdapter.class)
            @XmlSchemaType(name = "date")
            protected LocalDate resignationDate;
             ...
             *     
             */
            public void setResignationDate(LocalDate value) {
    ...
    public static class PSCs {
        ...
        @XmlElement(name = "CompanyStatement")
        ...
        public static class PSC {
                ...
                extends PSCNotificationReturnType
            {
                ...
                @XmlElement(name = "NotificationDate", required = true, type = String.class)
                @XmlJavaTypeAdapter(LocalDateXmlAdapter.class)
                @XmlSchemaType(name = "date")
                protected LocalDate notificationDate;
                @XmlElement(name = "CessationDate", type = String.class)
                @XmlJavaTypeAdapter(LocalDateXmlAdapter.class)
                @XmlSchemaType(name = "date")
    ...
    public static class Registers {
        ...
        @XmlElement(name = "HeldOnPublicRecord", required = true)
    ...
    public static class Shareholdings {
        ...
        @XmlElement(name = "NumberHeld", required = true)
        protected BigDecimal numberHeld;
        @XmlElement(name = "Shareholders", required = true)
