...
@XmlType(name = "PSCLinkedStatementType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "statement",
    "individual",
...
public class PSCLinkedStatementType {
    ...
    @XmlElement(name = "Statement", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
