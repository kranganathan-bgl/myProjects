...
@XmlType(name = "SICCodesType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "sicCode"
})
public class SICCodesType {

    @XmlElement(name = "SICCode", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
