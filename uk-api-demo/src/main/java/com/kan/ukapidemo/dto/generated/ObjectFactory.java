...
public class ObjectFactory {
    ...
    @XmlJavaTypeAdapter(LongXmlAdapter.class)
    public JAXBElement<Long> createSignatureMethodTypeHMACOutputLength(Long value) {
        return new JAXBElement<Long>(_SignatureMethodTypeHMACOutputLength_QNAME, Long.class, SignatureMethodType.class, value);
    }
