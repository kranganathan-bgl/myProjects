...
@XmlType(name = "SharesOrStockHeldType", propOrder = {
    "sharesHeld",
    "stockHeld"
})
public class SharesOrStockHeldType {

    @XmlElement(name = "SharesHeld")
    protected SharesOrStockHeldType.SharesHeld sharesHeld;
    @XmlElement(name = "StockHeld")
        ...
        extends SharesType
    {
        ...
        @XmlElement(name = "AmountPaidUp", required = true)
    ...
    public static class StockHeld {
        ...
        @XmlElement(name = "StockClass", required = true)
        protected String stockClass;
        @XmlElement(name = "AmountHeld", required = true)
