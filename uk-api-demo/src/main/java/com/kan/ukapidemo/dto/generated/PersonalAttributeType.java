...
@XmlType(name = "PersonalAttributeType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "personalAttribute",
    "personalData"
})
public class PersonalAttributeType {

    @XmlElement(name = "PersonalAttribute", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
    protected String personalAttribute;
    @XmlElement(name = "PersonalData", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
