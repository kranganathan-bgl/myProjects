...
@XmlType(name = "PSCChangeDetailsType", propOrder = {
    "individual",
...
public class PSCChangeDetailsType {
    ...
    @XmlElement(name = "DateOfChange", required = true, type = String.class)
     ...
     *     
     */
    public void setDateOfChange(LocalDate value) {
    ...
    public static class Corporate {
        ...
        public static class Change {
            ...
            @XmlElement(name = "PSCCompanyIdentification")
    ...
    public static class LegalPerson {
        ...
        public static class Change {
            ...
            @XmlElement(name = "LegalPersonName")
            protected String legalPersonName;
            @XmlElement(name = "Address")
            protected CompanyAddressType address;
            @XmlElement(name = "LegalPersonIdentification")
