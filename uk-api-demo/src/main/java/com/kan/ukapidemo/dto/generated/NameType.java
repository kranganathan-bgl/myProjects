...
@XmlType(name = "NameType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "forename",
    "surname"
})
@XmlSeeAlso({
    CorporateOfficerAppointmentType.class,
    IncorporationCorporateOfficerAppointmentType.class,
    com.kan.ukapidemo.dto.generated.DirectorIncorporationAppointmentType.Corporate.class
})
