...
@XmlType(name = "PSCCessationType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "individual",
...
public class PSCCessationType {
    ...
    @XmlElement(name = "CessationDate", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
