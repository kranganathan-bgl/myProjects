...
@XmlType(name = "SubsidiaryAndAssociatedUndertakingsType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "subCompanyName",
    "subCompanyNumber",
    "shareDescription",
    "otherDetails"
...
public class SubsidiaryAndAssociatedUndertakingsType {
    ...
    @XmlElement(name = "SubCompanyName", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
    protected String subCompanyName;
    @XmlElement(name = "SubCompanyNumber", namespace = "http://xmlgw.companieshouse.gov.uk")
    protected String subCompanyNumber;
    @XmlElement(name = "ShareDescription", namespace = "http://xmlgw.companieshouse.gov.uk")
    protected String shareDescription;
    @XmlElement(name = "OtherDetails", namespace = "http://xmlgw.companieshouse.gov.uk")
