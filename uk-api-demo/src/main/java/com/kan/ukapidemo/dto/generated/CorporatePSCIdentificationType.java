...
/**
 * <p>Java class for CorporatePSCIdentificationType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CorporatePSCIdentificationType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CorporatePSCIdentificationType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "pscPlaceRegistered",
...
public class CorporatePSCIdentificationType {

    @XmlElement(name = "PSCPlaceRegistered", namespace = "http://xmlgw.companieshouse.gov.uk")
    protected String pscPlaceRegistered;
    @XmlElement(name = "PSCRegistrationNumber", namespace = "http://xmlgw.companieshouse.gov.uk")
    ...
    @XmlElement(name = "CountryOrState", namespace = "http://xmlgw.companieshouse.gov.uk")
