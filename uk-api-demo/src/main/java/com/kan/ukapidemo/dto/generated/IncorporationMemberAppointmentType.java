...
@XmlType(name = "IncorporationMemberAppointmentType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "designatedInd",
    "person",
    "corporate"
})
public class IncorporationMemberAppointmentType {
    ...
    @XmlElement(name = "DesignatedInd", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
