...
@XmlType(name = "PSCLegalPersonType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "legalPersonName",
    "address",
...
public class PSCLegalPersonType {
    ...
    @XmlElement(name = "LegalPersonIdentification", namespace = "http://xmlgw.companieshouse.gov.uk", required = true)
