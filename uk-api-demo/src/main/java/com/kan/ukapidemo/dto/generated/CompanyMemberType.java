...
@XmlType(name = "CompanyMemberType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "memberClass",
    "name",
    "address"
})
public class CompanyMemberType {
    ...
    @XmlElement(name = "MemberClass", namespace = "http://xmlgw.companieshouse.gov.uk")
