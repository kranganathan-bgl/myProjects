...
public class GovTalkMessage {
    ...
    public static class GovTalkDetails {
        ...
        public static class GovTalkErrors {
            ...
            public static class Error {
                ...
                @XmlElement(name = "Number", namespace = "http://www.govtalk.gov.uk/schemas/govtalk/govtalkheader", type = String.class)
    ...
    public static class Header {
        ...
        public static class MessageDetails {
            ...
            @XmlElement(name = "GatewayTest", namespace = "http://www.govtalk.gov.uk/schemas/govtalk/govtalkheader", type = String.class)
            @XmlJavaTypeAdapter(LongXmlAdapter.class)
            @XmlSchemaType(name = "integer")
            protected Long gatewayTest;
            @XmlElement(name = "GatewayTimestamp", namespace = "http://www.govtalk.gov.uk/schemas/govtalk/govtalkheader", type = String.class)
