...
@XmlType(name = "IncorporationPSCNotificationType", namespace = "http://xmlgw.companieshouse.gov.uk", propOrder = {
    "individual",
    "corporate",
    "legalPerson",
...
public class IncorporationPSCNotificationType {
        ...
        extends PSCIndividualType
    {
        ...
        @XmlElement(name = "ConsentStatement", namespace = "http://xmlgw.companieshouse.gov.uk")
